...
const AboutUs = () => {
    return (
        <section className="relative w-full md:max-h-[709px] bg-[#F8F8FF] py-20 px-4 sm:px-8 md:px-10">
            <div className="flex flex-col lg:flex-row justify-center items-center gap-10 max-w-[1527px] mx-auto">
                {/* Left Image */}
                <div className="relative w-full max-w-[600px] max-h-[609px] sm:max-w-[682px] aspect-[682/609] overflow-hidden">
                    <div
                        className="shine-wrapper-about1 relative w-full h-full max-w-[600px] sm:max-w-[682px] aspect-[682/609]"
                ...
                {/* Text Content */}
                <div className="w-full max-w-[746px] flex flex-col gap-8">
                    {/* Title and Description */}
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center gap-2">
                            <img src={TitleIcon} alt="icon" className="h-4 w-4" />
                            <p className="text-[#5E5EEE] text-[30px] font-bold">About Us</p>
                        </div>
                        <h2 className="text-2xl sm:text-[40px] font-bold leading-tight text-black">
                    ...
                    {/* Button */}
                    <button className="mt-6 md:mt-3 px-6 py-3 bg-[#5E5EEE] text-white font-bold text-[16px] rounded-[20px] flex items-center gap-2 w-fit hover:bg-blue-800 transition">
